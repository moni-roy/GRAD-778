...
d.mat2 <- as.matrix(d.df[, 3:5], ncol = 3)
...
d.mat3 <- as.matrix(c(1, 2, 3), nrow = 3, ncol =2)
dim(d.mat3)
...
df_spatial <- data.frame(long = rep(seq(-1, 1, 0.5), times = 5) , lat = rep(seq(-1, 1, 0.5), each=5))
