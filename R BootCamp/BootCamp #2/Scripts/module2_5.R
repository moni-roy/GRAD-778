...
download.file(file_name, destfile = '../R BootCamp/BootCamp #2/Dataset/data.zip')
unzip(zipfile = '../R BootCamp/BootCamp #2/Dataset/data.zip')
...
## load reptile data 
reptiles <- readr::read_csv('../R BootCamp/BootCamp #2/Dataset/reptiles.csv')
